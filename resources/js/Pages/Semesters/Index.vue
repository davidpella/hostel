<template>
    <InertiaHead title="Semesters Management" />
                        ...
                        <table class="w-full mt-6">
                            <thead>
                                <tr class="border-b border-gray-300">
                                    ...
                                    <th class="text-xs text-left px-4 py-4">Academic year</th>
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td class="text-sm text-gray-700 text-left px-4 py-4">
                                        {{ format(semester.created_at) }}
                                    </td>
                                    <td class="text-sm text-gray-700 text-left px-4 py-4">
                                        {{ format(semester.updated_at) }}
                                    </td>
                                    <td class="text-sm text-gray-700 text-left px-4 py-4">
                                        <div class="flex items-center space-x-3">
                                            <InertiaLink class="text-blue-500 underline" :href="route('semesters.edit', semester)">
                                                Edit
                                            </InertiaLink>

                                            <InertiaLink class="text-red-500 underline" :href="route('semesters.destroy', semester)" method="delete" as="button" type="button">
                                                Delete
                                            </InertiaLink>
                                        </div>
                                    </td>
