<template>
    <InertiaHead title="Academic Years Management" />
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td class="text-sm text-gray-700 text-left px-4 py-4">
                                        {{ format(academicYear.created_at) }}
                                    </td>
                                    <td class="text-sm text-gray-700 text-left px-4 py-4">
                                        {{ format(academicYear.updated_at) }}
                                    </td>
                                    <td class="text-sm text-gray-700 text-left px-4 py-4">
                                        <div class="flex items-center space-x-3">
                                            <InertiaLink class="text-blue-500 underline" :href="route('academicYears.edit', academicYear)">
                                                Edit
                                            </InertiaLink>

                                            <InertiaLink class="text-red-500 underline" :href="route('academicYears.destroy', academicYear)" method="delete" as="button" type="button">
                                                Delete
                                            </InertiaLink>
                                        </div>
                                    </td>
                        ...
                        <div class="flex items-center justify-between pt-4">
                            <Pagination :payload="academicYears" />
                        </div>
                    </div>
                </div>
            </div>
