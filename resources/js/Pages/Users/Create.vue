                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-6 grid grid-cols-4 gap-3">
                            <div class="col-span-4">
                                ...
                                <BreezeInput id="email" type="email" class="mt-2 block w-full" v-model="form.email" />
                            </div>
                        </div>
                        ...
                        <div class="mt-6 grid grid-cols-4 gap-3">
                            <div class="col-span-4">
                                ...
                                <BreezeInput id="password" type="password" class="mt-2 block w-full" v-model="form.password" />
                            </div>
                        </div>
                    </div>
